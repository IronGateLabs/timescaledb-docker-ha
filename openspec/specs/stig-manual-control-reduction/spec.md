...
Define how PostgreSQL 16 STIG controls move from unknown or manual classifications into reviewed validation, deployment-owned, manual, or exception states.
